"""
CVE-2023-3519 — NetScaler ADC and NetScaler Gateway
...
class NetscalerAdcAndNetscalerGatewayCve3519(CVEPlugin):
    ...
    def matches(self, ctx: PluginContext) -> bool:
        # TODO: replace this with the real signature for CVE-2023-3519
