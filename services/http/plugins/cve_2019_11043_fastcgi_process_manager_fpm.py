"""
CVE-2019-11043 — FastCGI Process Manager (FPM)
...
class FastcgiProcessManagerFpmCve11043(CVEPlugin):
    ...
    def matches(self, ctx: PluginContext) -> bool:
        # TODO: replace this with the real signature for CVE-2019-11043
        ...
        product_slug = "fastcgi_process_manager_fpm"
