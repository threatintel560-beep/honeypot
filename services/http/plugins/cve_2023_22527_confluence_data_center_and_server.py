"""
CVE-2023-22527 — Confluence Data Center and Server
...
class ConfluenceDataCenterAndServerCve22527(CVEPlugin):
    ...
    def matches(self, ctx: PluginContext) -> bool:
        # TODO: replace this with the real signature for CVE-2023-22527
