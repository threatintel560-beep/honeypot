...
class SmallBusinessRv160Rv260Rv340AndRv345SeriesRoutersCve20701(CVEPlugin):
    cve_id = "CVE-2022-20701"
    ...
    def matches(self, ctx: PluginContext) -> bool:
        # TODO: replace this with the real signature for CVE-2022-20701
