"""
CVE-2021-26086 — Jira Server and Data Center
...
class JiraServerAndDataCenterCve26086(CVEPlugin):
    cve_id = "CVE-2021-26086"
    product = "Jira Server and Data Center"
    severity = "critical"
    description = 'Atlassian Jira Server and Data Center contain a path traversal vulnerability that allows a remote attacker to read particular files in the /WEB-INF/web.xml endpoint.'

    def matches(self, ctx: PluginContext) -> bool:
        # TODO: replace this with the real signature for CVE-2021-26086
        ...
        product_slug = "jira_server_and_data_center"
